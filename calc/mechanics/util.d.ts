import type { Generation, MoveCategory, StatID, StatsTable, TypeName, Weather } from '../data/interface';
...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean, isBoneZone?: boolean, isCorrosion?: boolean): number;
...
export declare function checkRawStatChanges(pokemon: Pokemon, powerTrickActive?: boolean, wonderRoomActive?: boolean): void;
...
export declare function getShellSideArmCategory(source: Pokemon, target: Pokemon, wonderRoomActive?: boolean): MoveCategory;
...
export declare function getStatDescriptionText(gen: Generation, pokemon: Pokemon, stat: StatID, powerTrickActive?: boolean, wonderRoomActive?: boolean): string;
